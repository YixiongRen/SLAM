...
def get_corresponding_points_on_wall(points,
    ...
    for i in xrange(len(points)):
        if abs(points[i][0])<eps:
            ...
            pass
##        if points[i][1]<eps:#bottom
##            if points[i][0]<points[i][1]:
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((arena_left,points[i][1]))
##            elif points[i][0]==points[i][1]:
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((arena_left,arena_bottom))
##            elif points[i][1]>((-1)*arena_top/arena_right*points[i][0]+arena_top):
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((arena_right,points[i][1]))
##            elif points[i][1]==((-1)*arena_top/arena_right*points[i][0]+arena_top):
##                left_list.append((points[i][0],points[i][1]))
...
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((points[i][0],arena_bottom))
##        elif points[i][1]>(arena_top-eps):#top
##            if points[i][0]>points[i][1]:
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((arena_right,points[i][1]))
##            elif points[i][0]==points[i][1]:
...
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((arena_left,points[i][1]))
##        elif points[i][0]>(arena_right-eps):#right
##            if points[i][0]<points[i][1]:
##                left_list.append((points[i][0],points[i][1]))
##                right_list.append((points[i][0],arena_top))
##            elif points[i][0]==points[i][1]:
